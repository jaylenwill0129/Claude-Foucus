...
const BASE_PROMPT =
  ...
  "COMPETITIVE VALIDATION: before drafting or publishing any product, benchmark it against the BEST-RATED competitor already on the market (rating, review volume, price, strength). Only proceed if your product can beat or match the leader on quality/value AND clear a healthy margin — a product worse than what's already selling won't get bought, so reject it and re-source. " +
